...
public class ChildAdapter extends RecyclerView.Adapter<ChildAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            childName = (TextView) itemView.findViewById(R.id.childNameEditText);
            birthDate = (TextView) itemView.findViewById(R.id.birthdateEditText);
            gender = (TextView) itemView.findViewById(R.id.genderEditText);
            seed = (TextView) itemView.findViewById(R.id.seed);
        }
    }
}
