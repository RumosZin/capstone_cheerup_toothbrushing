...
//
//        // Python 모듈 로드 및 함수 호출
//        PyObject pyObject = py.getModule("my_python_script"); // 'my_python_script'는 Python 파일 이름
//        PyObject result = pyObject.callAttr("my_function", "argument1", 123); // 'my_function'은 호출할 함수 이름
//
//        // 결과 사용
